...
class MiniTriniApp:
    ...
    def canvas_log(self, summary, tags=None, source="manual"):
    ...
    print(">>> FALLTHROUGH TO CHAT")
    def process_user_input(self, text):
        self.memory.append(("User", text))
        
    print(">>> ENTER process_user_input")    
        # ==================================================================
        ...
        if t.startswith("open module "):
            ...
            if state and state.get("file"):
                ...
                if file_path.exists():
                    ...
                    self.emit("chat","System", f"[Canvas] resumed → {state['file']}")
                    return
                ...
                for root, dirs, files in os.walk(mod_dir):
                    for f in files:
                        if f.endswith(".py"):
                            ...
                            self.emit("chat","System", f"[Canvas] auto-opened → {rel_path}")
                            return
